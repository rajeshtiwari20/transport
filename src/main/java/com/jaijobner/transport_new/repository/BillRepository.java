...
public interface BillRepository extends JpaRepository<BillEntity, Long>, JpaSpecificationExecutor<BillEntity> {
    Optional<BillEntity> findByConsigneeAndYearAndMonth(PartyEntity consignee, Year year, Integer month);

    Optional<BillEntity> findFirstByBillNumberStartingWithOrderByIdDesc(String prefix);
}
